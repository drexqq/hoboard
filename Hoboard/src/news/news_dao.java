...
public class News_Dao {
	...
	public List<News_Dto> getnews_list(String choice, String searchWord) {
		...
		String sql = " SELECT NEWS_SEQ, ID, TITLE, CONTENT, VIEWCOUNT, WDATE" + " FROM NEWS " + " ORDER BY WDATE DESC";
	...
	// 페이징
	public List<News_Dto> getNewsPagingList(String choice, String searchWord, int page) {
		...
		sql += "(SELECT ROW_NUMBER()OVER(ORDER BY WDATE) AS RNUM, " + " NEWS_SEQ, ID, TITLE, CONTENT, VIEWCOUNT, WDATE "
				+ " FROM NEWS ";
